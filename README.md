...
* **2019-09-13**: Borderlands 3 Initial Release (version `1.0.0 CL 2005984` -
  *confirmation needed for version number*)
...
* **2019-09-26**: First BL3 patch (to version `1.0.1 CL 2015653`
  *(confirmation needed for version number)*)
